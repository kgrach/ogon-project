...
sudo dnf install openssl-devel.x86_64 libXext-devel.x86_64 libXcursor-devel.x86_64 libXinerama-devel.x86_64 libXext-devel.x86_64 libXdamage-devel.x86_64 libXv-devel.x86_64 \

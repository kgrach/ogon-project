...
sudo dnf install xmlto.x86_64 fop.noarch libtool.x86_64 pixman-devel.x86_64 pixman-devel.x86_64 xorg-x11-proto-devel.noarchs ust-x11rb-protocol+composite-devel.noarch \
